    ...
    <>
      <div className="bg-[#111113] border border-white/5 rounded-2xl overflow-hidden">
        ...
        <div className="p-4 border-b border-white/5">
          ...
          <p className="text-xs text-white/40 mt-1">Click a project to view tasks & delegate</p>
        </div>
        ...
        <div className="grid grid-cols-2 divide-x divide-y divide-white/5">
          {PROJECTS.map(project => (
            ...
            >
              ...
              <h4 className="font-medium text-white text-sm group-hover:text-[#4169E1] transition-colors">
                {project.name}
              </h4>
